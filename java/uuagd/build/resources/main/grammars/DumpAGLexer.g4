...
TYPE_SIGS_KEY : 'typeSigs: ' -> skip, pushMode(TYPE_SIGS);
KEY : NAME ': '
  {
    String name = getText();
...
TYPE_SIGS_ANY_CHAR : ANY_CHAR -> skip;
TYPE_SIGS_BIG_LIST_END : BIG_LIST_END -> skip, popMode;